...
scoreboard players set @s ct.VEHICLE.CameraDist.Z -4500
...
scoreboard players set @s ct.VEHICLE.InitiateFirstRollDelay 10

# // Mass is Only Used to Calculate How Impactful the Vehicle is Upon Crashing
scoreboard players set @s ct.VEHICLE.Mass 1000
