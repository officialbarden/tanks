...
execute as @p[predicate=ct:id] unless score @s ct.VEHICLE.Speed matches 0 rotated as @n[tag=ct.VEHICLE, predicate=ct:id, type=mannequin] rotated ~ ~ run function ct:zprivate/movement/move/create_vec
