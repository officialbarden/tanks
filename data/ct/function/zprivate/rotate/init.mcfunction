...
execute if predicate ct:is_moving as @e[predicate=ct:id, tag=ct.COMPONENTS, tag=!ct.FOLLOW_PLAYER, type=item_display] run function ct:zprivate/smooth_rotation/body
